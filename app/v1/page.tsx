// app/v1/page.tsx
//
// /v1 — preserved "Tier Z+" home (the cream foyer + hand-drawn marks + four-
// rooms structure that preceded the "Two Hands" direction). Reachable at
// /v1 so the prior aesthetic is still browsable for reference.
//
// Source: prior (foyer)/page.tsx, archived verbatim 2026-05-19.
...
export const metadata: Metadata = {
  title: "Tier Z+ — archived foyer home",
  description:
    "Preserved snapshot of the cream-paper foyer home with hand-drawn marks. Superseded by the Two Hands direction at /.",
...
const HERO_BREAK_AT = 6;

export default async function V1FoyerHomePage() {
