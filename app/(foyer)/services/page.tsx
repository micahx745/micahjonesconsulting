...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    anchorNote:
      "Anchor: Ordani — HIPAA-grade practice management software, solo built, used by 200 birth workers; HR-author full-stack engagement (website + content engine + GTM + bespoke product).",
    tiers: [
      {
        name: "Advisory",
