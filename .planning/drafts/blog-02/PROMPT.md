# Draft blog post 2 for micahjonesconsulting.com: landing pages

TOPIC (from the evidence): people asking about their landing page mostly want it to CONVERT or to get first users, not
help BUILDING it (34 asking authors: 18 conversion/first-users vs 4 building). A distinct group says the page cannot
explain the product. Their words, verbatim, public posts: "I keep rewriting my landing page and I still can't say in one
sentence what problem it actually solves" · "I'm struggling to explain the product in one clear sentence now." · "I'm
explaining it poorly and people don't get the value" · "Does the landing page communicate what this does?" · "Is the
value proposition unclear?" · "might be too technical for everyday users to grasp quickly" · "The landing page / App
Store listing isn't converting". The post answers: why isn't my landing page converting, and how do I say what my app
does in one sentence. It is about the WORDS on the page and what to test, not about page builders.
