...
STAGE: Stage 2 (the results-lead poster in app/(theater)/work/[slug]/page.tsx §3.3, WITHOUT the clip line). K lines still expected-FAIL.

LAST LINE MARKER: band-stage2-kite-52
