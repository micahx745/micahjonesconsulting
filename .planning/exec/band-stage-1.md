...
STAGE: Stage 1 (the title poster: lib/title-figure.ts, components/TitleCard.tsx, app/globals.css §3.5 + §4). Expected-FAIL on birth-worker B2 and on every K line; report them as expected.

LAST LINE MARKER: band-stage1-ibis-41
