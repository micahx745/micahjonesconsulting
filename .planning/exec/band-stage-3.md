...
STAGE: Stage 3 (the clip: components/StudyBandClip.tsx §3.4, the media line in §3.3, the clip CSS in §3.5 and §4). Every B and K line must PASS.

LAST LINE MARKER: band-stage3-wren-68
