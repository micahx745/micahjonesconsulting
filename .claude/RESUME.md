...
purchase. No Stripe env in Production (build tolerates absence; proven).
...
button + launch email. Runbooks: PACKAGES-RUNBOOK.md, HANDOFF.md.
...
## Gotchas
- Pane screenshots go black after scrolling → chrome-devtools MCP for scrolled shots.
- Git Bash /tmp invisible to Windows python; big heredocs break → Write script, run it.
