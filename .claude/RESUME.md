...
## READ FIRST
Pass-123 SHIPPED (Opus 5 main). 11:00: 5h 6%, week 8%, Fable 6%. GLM 94%
(resets ~09-22) = OUT; grunt = Sonnet legs (Chrome) + Sol (`codex-exec.ps1
-Task`); gates = Opus/Fable/Astra. NEW: DeepSeek is the 4th cross-review REST
leg (`--legs deepseek`; DEEPSEEK_API_KEY or .claude/.deepseek-key, NOT SET yet
- the chat-pasted key must be rotated). get_usage before every fan-out. pnpm
-> C:/Users/micah/AppData/Roaming/npm/pnpm.cmd; serve `node node_modules/next/
