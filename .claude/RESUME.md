...
get_usage before every fan-out. pnpm may be off PATH ->
C:/Users/micah/AppData/Roaming/npm/pnpm.cmd; serve via
...
Earlier: CLS 0.00000 all five studies both widths; LH mobile median 3375.8ms
after vs 3389.8 before; route JS +1363B (limit 6144).
...
2. /work/guardicore mobile LCP ~3.4s (text LCP), pre-existing; Speed Insights
   field data is the agreed judge (Pass-120).
3. K5@390 harness race (background task filed).
4. HandCircle.tsx delete: ask him. Kickoff items 1-2 are DONE (small fixes
   landed in Pass-123a-d; RFP provenance = LESSONS #3 lines 785-799).
