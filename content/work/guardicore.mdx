...
results:
  ...
  rest: "$1.2M average enterprise deal."
entry:
  context: "Guardicore, acquired by Akamai"
  figure: "$14M"
  line: "in revenue, sourced and closed, at a $1.2M average enterprise deal."
  did: "I ran the research that found what those buyers were actually signing for, moved the story from honeypots to east-west visibility, and sat in the deals."
