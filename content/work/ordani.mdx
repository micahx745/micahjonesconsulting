---
title: ORDANI
dek: A HIPAA-compliant CRM for birth workers — a company I founded and built. Hundreds of birth workers pay for it; none lost to a competitor.
...
Row-level security policies are the difference between a CRM that says "HIPAA-compliant" on the homepage and one that actually is. I wrote the policies, then paid two independent security reviewers, one in healthcare and one in database security, to attack them. What they found got fixed. The final pass held.
...
Hundreds of birth workers pay for it today, and none have left for a competitor. The first HIPAA-compliant CRM built for the doula market.
