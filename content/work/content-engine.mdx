...
dek: "A social activist's message had been landing in every room and nowhere online. I wrote the platform strategy, then built an AI engine that turns one rough video into the week's work: finished videos, the blog post, and the whole marketing flow for the idea it argues."
...
entry:
  ...
  figure: "Up to 800,000"
  line: "impressions in a month, up from a few thousand a month."
